...
public class ResponseJpaController implements Serializable {
    ...
    public ResponseJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Response response) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findResponse(response.getRId()) != null) {
